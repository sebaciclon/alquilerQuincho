    ...
    <x-app-layout>
        <div class="p-3 table-responsive">
            @if ( $alquileres->isEmpty())
                <h1 class="d-flex justify-content-center mt-5">No hay alquileres cargados con el nombre <strong> "{{$buscar}}" </strong></h1>
            @else
                <h2 class="mb-3"><b>Alquileres cargados con el nombre <strong> "{{$buscar}}" </strong></b></h2>
